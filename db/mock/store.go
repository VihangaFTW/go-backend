...
// Source: github.com/VihangaFTW/Go-Backend/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -destination db/mock/store.go github.com/VihangaFTW/Go-Backend/db/sqlc Store
//
...
import (
	...
	sqlc "github.com/VihangaFTW/Go-Backend/db/sqlc"
...
func (m *MockStore) CreateTranfer(ctx context.Context, arg sqlc.CreateTranferParams) (sqlc.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTranfer", ctx, arg)
...
func (mr *MockStoreMockRecorder) CreateTranfer(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTranfer", reflect.TypeOf((*MockStore)(nil).CreateTranfer), ctx, arg)
}
...
func (m *MockStore) GetTranfer(ctx context.Context, id int64) (sqlc.Transfer, error) {
	m.ctrl.T.Helper()
